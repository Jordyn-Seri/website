...
const caseStudies = [
  {
    ...
    result: "Eliminated 3,500+ manual claims/year",
    metric: "3,500+",
    metricLabel: "claims automated",
  },
  {
    tag: "Medicaid Operations",
    problem: "Complex Medicaid operations across multiple partners with inconsistent billing processes.",
    solution: "Built standardized workflows and oversight systems for billing accuracy.",
    result: "Managed operations for 14,000+ members with 98% billing success",
    metric: "98%",
  ...
  },
  {
    ...
    solution: "Developed reporting dashboards providing real-time, actionable data to stakeholders.",
    result: "Delivered actionable reporting for 20+ statewide partners",
    metric: "20+",
